<div align="center" width="100%">
    <img src="./snapparoo-logo.svg" width="128" alt="" />
</div>

# Snapparoo </br>
<a href="https://trendshift.io/repositories/8929" target="_blank"><img src="https://trendshift.io/api/badge/repositories/8929" alt="snapparoo%2Fsnapparoo | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>

[![GitHub Actions Workflow Status][check-workflow-badge]][check-workflow-badge-link] [![GitHub License][github-license-badge]][github-license-badge-link]  [![Discord][discord-badge]][discord-badge-link] [![Snapparoo][made-by-nextify-badge]][made-by-nextify-badge-link]
...
![COMMIT_ACTIVITY](https://img.shields.io/github/commit-activity/m/snapparoo/snapparoo?style=for-the-badge">)
[![Visitors](https://api.visitorbadge.io/api/visitors?path=https%3A%2F%2Fgithub.com%2Fsnapparoo%2Fsnapparoo&labelColor=%23f47373&countColor=%23263759)](https://visitorbadge.io/status?path=https%3A%2F%2Fgithub.com%2Fsnapparoo%2Fsnapparoo)

An easy-to-use and enterprise-grade Next.js boilerplate.

You don't need to buy templates anymore; Snapparoo provides a complete, open-source solution for building SaaS applications quickly and easily.
...
Demo Server (Location: Washington - USA): <https://show.snapparoo.io>

See more documentation at <https://document.snapparoo.io>

## 🌟 Star History

[![Star History Chart](https://api.star-history.com/svg?repos=snapparoo/snapparoo&type=Timeline)](https://star-history.com/#snapparoo/snapparoo&Timeline)
...
[![Deploy with Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https%3A%2F%2Fgithub.com%2Fsnapparoo%2Fsnapparoo&env=NEXT_PUBLIC_APP_URL,NEXTAUTH_URL,NEXTAUTH_SECRET,STRIPE_API_KEY,STRIPE_WEBHOOK_SECRET,POSTGRES_URL,GITHUB_CLIENT_ID,GITHUB_CLIENT_SECRET,RESEND_API_KEY,RESEND_FROM&install-command=bun%20install&build-command=bun%20run%20build&root-directory=apps%2Fnextjs)
...
```bash
bun create snapparoo 
```

2. Manually clone the repository:

```bash
git clone https://github.com/snapparoo/snapparoo.git
cd snapparoo
bun install
```
...
1. Admin Dashboard Page (in alpha !!!)
   ...
   3. You can provide your admin account and change **ADMIN_EMAIL="admin@snapparoo.io,root@snapparoo.io"** in .env.local and access host:port/admin/dashboard
...
<a href="https://github.com/snapparoo/snapparoo/graphs/contributors">
  <img src="https://contrib.rocks/image?repo=snapparoo/snapparoo" />
</a>
...
[check-workflow-badge]: https://img.shields.io/github/actions/workflow/status/snapparoo/snapparoo/ci.yml?label=ci
[github-license-badge]: https://img.shields.io/badge/License-MIT-green.svg
[discord-badge]: https://img.shields.io/discord/1204690198382911488?color=7b8dcd&link=https%3A%2F%2Fsnapparoo.io%2Fdiscord
[made-by-nextify-badge]: https://img.shields.io/badge/made_by-nextify-blue?color=FF782B&link=https://nextify.ltd/

[check-workflow-badge-link]: https://github.com/snapparoo/snapparoo/actions/workflows/check.yml
[github-license-badge-link]: https://github.com/snapparoo/snapparoo/blob/main/LICENSE
