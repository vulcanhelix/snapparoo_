...
const meteors_data: Meteor = {
  name: "Find the Best Photography Settings",
  description:
    "Find the ideal photography setting for your ecommerce product from China",
  button_content: "Chat with us",
  url: "https://wa.me/61433344890",
};
        ...
        <div className="grid grid-cols-1 gap-10 pb-10 md:pb-40 xl:grid-cols-2">
          <div className="flex flex-col items-start">
            <div className="flex flex-col pt-4 md:pt-28 lg:pt-28 xl:pt-28">
              <a href="https://wa.me/61433344890" target="_blank" rel="noopener noreferrer">
                <DocumentGuide>
                  {dict.marketing.introducing || "Introducing Snapparoo"}
                </DocumentGuide>
              </a>
              ...
              <div className="mt-6">
                <h1 className="relative mb-6 max-w-4xl text-left text-4xl font-bold dark:text-zinc-100 sm:text-7xl md:text-7xl xl:text-7xl">
                  {dict.marketing.title ||
                    "Snapparoo: Easy, quick product from, directly from you China manufacturer."}
                </h1>
              </div>
              ...
              <div>
                <span className="text-zinc-500 sm:text-xl">
                  {dict.marketing.sub_title ||
                    "Same-day professional product photos, straight from the source"}
                </span>
