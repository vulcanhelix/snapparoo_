import { FollowerPointerCard } from "@snapparoo/ui/following-pointer";
...
const blogContent = {
  slug: "Instant Product Photography for all your China Manufactured Products",
  author: "Snapparoo",
  date: "26th March, 2024",
  title: "Same Day Product Photography, all in China",
  description:
    "So, here's something weird...a revolutionary product that has nothing to do with AI...haha",
  image:
