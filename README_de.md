...
Sie müssen keine Vorlagen mehr kaufen; Snapparoo bietet eine vollständige Open-Source-Lösung zum schnellen und einfachen Erstellen von SaaS-Anwendungen.
...
Demo-Server (Standort: Washington, USA): <https://show.snapparoo.io>

Weitere Dokumentation finden Sie unter <https://document.snapparoo.io>.
...
1. Admin-Dashboard-Seite (in Alpha!!!)
   ...
   3. Sie können Ihr Admin-Konto angeben, indem Sie **ADMIN_EMAIL="admin@snapparoo.io,root@snapparoo.io"** in .env.local ändern und auf host:port/admin/dashboard zugreifen
